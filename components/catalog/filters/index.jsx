  ...
  return (
    <Container className={classes.root}>
      <Typography className={classes.breadcrumbs}>
        <Link to="/" className={classes.homepageLink}>Главная</Link>
        <span> - каталог</span>
      </Typography>
      <BlockTitle>
      ...
      <section className={classes.sectionPickerSection}>
        <SectionPicker options={options.sections} value={filter.section} onChange={onChange} />
      </section>
      <section className={classes.secondTitle}>
        <BlockTitle>
          <Typography variant="h4">
            {options.sections
              .reduce((res, curr) => (
                curr.id === filter.section ? curr.title : res
