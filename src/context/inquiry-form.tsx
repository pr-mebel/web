...
export const InquiryFormProvider = ({ children }: FormSubmitionProviderProps) => {
    const analytics = useYaCounter54949111();
    const [reference, setReference] = useState<NodeJS.Timeout | null>(null);
    const [inquiryFormMeta, setInquiryFormMeta] = useState<Record<string, unknown>>({});
    ...
    return (
        <InquiryFormContext.Provider value={value}>
            ...
            />
            <FormSubmitPopup isOpen={successModal.isOpen} onClose={successModal.handleClose} />
